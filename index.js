...
// Guest cart key - defined at the top for global access
...
function initializeCartBadge() {
    try {
        ...
        console.error('Error initializing cart badge:', e);
    }
}
...
function displayCartModal() {
    ...
    if (!cartBody || !cartFooter) {
        console.error('Cart modal body or footer not found!');
        return;
    }
...
window.toggleWishlistFromHome = toggleWishlistFromHome;