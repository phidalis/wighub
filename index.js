...
// Load featured products from Firebase Firestore
async function loadFeaturedProducts() {
    console.log('Loading products for home page from Firestore...');
    showLoading();
    ...
    try {
        ...
        querySnapshot.forEach(doc => {
            ...
            // CRITICAL FIX: Ensure image URL is set correctly
            // Firebase Storage returns imageUrl, not image
            productData.image = productData.imageUrl || productData.image || 'https://via.placeholder.com/400x400?text=Product';
            productData.imageUrl = productData.imageUrl || productData.image;
            ...
            // Only include active products for home page
...
// Fallback to localStorage for home page
