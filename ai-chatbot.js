...
sendMessage: function() {
    ...
    setTimeout(() => {
     ...
     // Add method to send live message
...
// Add method to check for new admin messages
...
// Replace your existing requestLiveSupport function with this
...
// Add this new function to check for agent assignment
checkForAgentAssignment: function(requestId) {
    ...
    checkForActiveSupport: function(requestId) {
        ...
        // Add method to initialize live chat
