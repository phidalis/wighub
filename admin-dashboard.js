...
// Filter customers - FIXED with async
async function filterCustomers() {
    ...
    for (const client of filteredClients) {
        ...
        try {
            ...
            const q = query(ordersRef, where('customer.email', '==', client.email));
            ...
            console.warn('Could not load orders for client:', client.email);
        }
...
// Load customers table - UPDATED VERSION (ID column removed)
async function loadCustomersTable() {
    ...
    await loadClients(); // Reload clients from Firebase
    ...
    let html = '';
    for (const client of allClients) {
        // Get client orders from Firestore
        let orderCount = 0;
        let totalSpent = 0;
