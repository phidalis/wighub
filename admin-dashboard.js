    ...
    reader.onload = function(e) {
        try {
            ...
            if (backup.data.affiliateEarnings) {
                ...
                console.log('✅ Restored affiliate earnings');
            }
            
            // ===== NEW: Restore affiliate referrals =====
            if (backup.data.affiliateReferrals) {
                ...
                console.log('✅ Restored affiliate referrals');
            }
            
            // ===== NEW: Restore referral codes =====
            if (backup.data.referralCodes) {
                ...
                console.log('✅ Restored referral codes');
            }
            ...
            showAdminNotification('✅ Data restored successfully! (Includes Braiders and Affiliate data)', 'success');
