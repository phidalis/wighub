...
function setupEventListeners() {
    ...
    // Load analytics with a small delay to ensure DOM is ready
    setTimeout(() => {
        loadAnalytics();
    }, 200);
    break;
...
// Make sure guest orders load when page initializes
document.addEventListener('DOMContentLoaded', function() {
    console.log('Admin Dashboard Initializing...');
    ...
    // ADD THIS LINE - exactly where affiliate is added
...
// Add to admin-dashboard.js - Add Affiliate menu item
